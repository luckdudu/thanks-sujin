...
const bannerImages = importAll(require.context(`../images/banner`, false, /\.(png|jpe?g|gif|svg)$/));
...
const AddSome = () => {
  ...
  return (
    ...
    <div className='text-color'>
        <div>
            <p>
                <span className='fs-4 fw-mute'>그 외</span><br />
                <span className='fs-1 fw-bold'>블로그 스킨디자인</span>
            </p>
        </div>
        {/* 카드 */}  
